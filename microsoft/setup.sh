...
echo "[INFO] Starting setup for microsoft at $(gdate -Iseconds)"
install_homebrew_mac
ensure_tools git jq yq gnu-sed coreutils azure-cli powershell node dotnet gh
...
echo "COMPANY=microsoft" > "$ROOT_DIR/generated/env.meta"
echo "TOOLS=git jq yq gnu-sed coreutils azure-cli powershell node dotnet gh" >> "$ROOT_DIR/generated/env.meta"

echo "[INFO] Completed bootstrap for microsoft."
