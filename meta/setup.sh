...
echo "[INFO] Starting setup for meta at $(gdate -Iseconds)"
install_homebrew_mac
ensure_tools git jq yq gnu-sed coreutils python@3.11 node watchman
...
echo "COMPANY=meta" > "$ROOT_DIR/generated/env.meta"
echo "TOOLS=git jq yq gnu-sed coreutils python@3.11 node watchman" >> "$ROOT_DIR/generated/env.meta"

echo "[INFO] Completed bootstrap for meta."
