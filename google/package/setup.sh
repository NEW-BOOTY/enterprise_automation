...
on_exit()  { echo "[INFO] $SCRIPT_NAME finished at $(date -Is)"; }
...
echo "[INFO] Starting setup for google at $(date -Is)"
install_homebrew_mac
ensure_tools git jq yq gnu-sed coreutils go python@3.11 bazelisk kubectl google-cloud-sdk
...
echo "COMPANY=google" > "$ROOT_DIR/generated/env.meta"
echo "TOOLS=git jq yq gnu-sed coreutils go python@3.11 bazelisk kubectl google-cloud-sdk" >> "$ROOT_DIR/generated/env.meta"

echo "[INFO] Completed bootstrap for google."
