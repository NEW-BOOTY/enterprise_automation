...
echo "[INFO] Starting setup for apple at $(gdate -Iseconds)"
install_homebrew_mac
ensure_tools git jq yq gnu-sed coreutils
...
echo "COMPANY=apple" > "$ROOT_DIR/generated/env.meta"
echo "TOOLS=git jq yq gnu-sed coreutils" >> "$ROOT_DIR/generated/env.meta"

echo "[INFO] Completed bootstrap for apple."
